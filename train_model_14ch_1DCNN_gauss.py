...
# ディレクトリの作成
os.makedirs('./results/14ch_1DCNN_gauss/distributions', exist_ok=True)
...
if __name__ == "__main__":
    ...
    # モデルの保存
    valence_model.save(f'./results/14ch_1DCNN_gauss/models/neuron{n_neurons}_sigma{sigma}_valence_model.keras')
    arousal_model.save(f'./results/14ch_1DCNN_gauss/models/neuron{n_neurons}_sigma{sigma}_arousal_model.keras')
